    ...
    <div class="flex pt-12 overflow-hidden">
        ...
        <div id="main-content" class="relative text-gray-900 dark:text-gray-200 font-poppins w-full min-h-screen overflow-y-auto lg:ml-80 pl-4 pr-8">
            ...
            <div class="px-6 py-8">
                    ...
                    <div>
                        <div id="dropdownMenu1" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
                            <ul class="py-2 text-sm text-gray-700 dark:text-gray-200">
                                <li><a href="#" class="block px-4 py-2 hover:bg-blue-100 dark:hover:bg-blue-600 dark:hover:text-white">S1</a></li>
                                <li><a href="#" class="block px-4 py-2 hover:bg-blue-100 dark:hover:bg-blue-600 dark:hover:text-white">S2</a></li>
                            </ul>
                        </div>
                    </div>
                ...
                <!-- Card Section -->
                <div class="bg-gradient-to-br from-blue-50 to-blue-100 border border-blue-200 rounded-3xl shadow-2xl overflow-hidden dark:border-blue-700 dark:bg-gradient-to-br dark:from-blue-900 dark:to-blue-900">
                    <div class="overflow-x-auto">
                        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                            <thead class="text-xs text-white uppercase bg-gradient-to-r from-blue-500 to-blue-600 dark:from-blue-700 dark:to-blue-800">
                                <tr>
                            ...
                            <tbody>
                                <tr class="bg-white border-b dark:bg-blue-800 dark:border-blue-700 hover:bg-blue-50 dark:hover:bg-blue-700 transition duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-[1.02]">
                                    ...
                                    <td class="px-4 py-3 font-medium text-gray-900 dark:text-white whitespace-nowrap">Muhammad Raja Fadhil Habibi</td>
                                    <td class="px-4 py-3 text-white">
                                        <span class="inline-flex items-center px-2 py-1 text-xs font-medium text-green-700 bg-green-100 rounded-full dark:bg-green-900 dark:text-green-300 animate-pulse">
                                            Aktif
                                        </span>
                                    </td>
                                ...
                                <tr class="bg-white border-b dark:bg-blue-800 dark:border-blue-700 hover:bg-blue-50 dark:hover:bg-blue-700 transition duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-[1.02]">
                                    ...
                                    <td class="px-4 py-3 font-medium text-gray-900 dark:text-white whitespace-nowrap">Riski Akbar Firmansah</td>
                                    <td class="px-4 py-3 text-white">
                                        <span class="inline-flex items-center px-2 py-1 text-xs font-medium text-red-700 bg-red-100 rounded-full dark:bg-red-900 dark:text-red-300 animate-pulse">
                                            Cuti
                                        </span>
                                    </td>
                                ...
                                <tr class="bg-white border-b dark:bg-blue-800 dark:border-blue-700 hover:bg-blue-50 dark:hover:bg-blue-700 transition duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-[1.02]">
                                    ...
                                    <td class="px-4 py-3 font-medium text-gray-900 dark:text-white whitespace-nowrap">gak tau lah</td>
                                    <td class="px-4 py-3 text-white">
                                        <span class="inline-flex items-center px-2 py-1 text-xs font-medium text-yellow-700 bg-yellow-100 rounded-full dark:bg-yellow-900 dark:text-yellow-300 animate-pulse">
                                            Tidak Aktif
                                        </span>
                                    </td>
                                ...
                                <tr class="bg-white border-b dark:bg-blue-800 dark:border-blue-700 hover:bg-blue-50 dark:hover:bg-blue-700 transition duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-[1.02]">
                                    ...
                                    <td class="px-4 py-3 font-medium text-gray-900 dark:text-white whitespace-nowrap">Aryela Rachma</td>
                                    <td class="px-4 py-3 text-white">
                                        <span class="inline-flex items-center px-2 py-1 text-xs font-medium text-green-700 bg-green-100 rounded-full dark:bg-green-900 dark:text-green-300 animate-pulse">
                                            Aktif
                                        </span>
                                ...
                                <tr class="bg-white border-b dark:bg-blue-800 dark:border-blue-700 hover:bg-blue-50 dark:hover:bg-blue-700 transition duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-[1.02]">
                                    ...
                                    <td class="px-4 py-3 font-medium text-gray-900 dark:text-white whitespace-nowrap">Indana Najwa</td>
                                    <td class="px-4 py-3 text-white">
                                        <span class="inline-flex items-center px-2 py-1 text-xs font-medium text-orange-700 bg-orange-100 rounded-full dark:bg-orange-900 dark:text-orange-300 animate-pulse">
                                            Menunggu
                                        </span>
                                    </td>
