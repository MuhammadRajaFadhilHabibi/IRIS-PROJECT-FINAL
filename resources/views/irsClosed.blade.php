        ...
        <div id="main-content" class="relative w-full h-full font-poppins overflow-y-auto lg:ml-52 dark:bg-blek-900">
            ...
            <div class="flex flex-col justify-center items-center px-6 mx-auto h-screen xl:px-0 dark:bg-blek-900">
                <div class=" md:max-w-xs ">
                    <img src="{{ asset('maintenance.jpg') }}"alt="maintenance image">
                </div>
                <div class="text-center xl:max-w-4xl">
                    <h1 class="text-xl font-bold leading-tight text-gray-900 sm:text-4xl lg:text-3xl">Periode Pengisian IRS Sudah Ditutup !</h1>
                    ...
                    onclick="Ajuan('{{ $email }}')" 
                    class="mt-10 text-white {{ $aksesirs == 'no' ? 'bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800' : 'bg-gray-600' }} font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center mr-3">
