...
<head>
    ...
    rel="stylesheet">
    <link rel="icon" type="image/x-icon" href="{{ asset('iris.png') }}">
    <link rel="icon" type="image/png" sizes="32x32" href="{{ asset('iris.png') }}">
    <link rel="shortcut icon" href="{{ asset('iris.png') }}">
